...
function doSomething(scroll_pos) {
 ...
 linear-gradient(${fromPercent(70, 110, percentage)}deg, rgba(30, 120, 70) 20%, rgba(10, 201, 80, 0.4) 0),
 linear-gradient(${fromPercent(20, 155, percentage)}deg, rgba(20, 3, 7) 85%, rgba(10, 33, 17, 0.22872899159663862) 2%)
 `;
}
